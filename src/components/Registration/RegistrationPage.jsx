        ...
        <div className={RPStyles.mainContainer}>
            ...
            <form onSubmit={createNewAccount}>
                <div className={RPStyles.contentContainer} >
                    ...
                    <EmailInput placeholder={'E-mail'} name={'email'} value={email} onChange={(e) => setEmail(e.target.value)} ref={inputRef}/>
                    <PasswordInput placeholder={'Пароль'} icon={'ShowIcon'} name={'password'}  value={password} onChange={(e) => setPassword(e.target.value)} ref={inputRef} type={'password'}/>
